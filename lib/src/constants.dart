...
const kPrimaryBlack=Color(0xff311b92);



String kkFontFamily='Changa';


String kQuote='Nothing in life is to be feared, '
    'it is only to be understood. Now is the time to understand more,'
    ' so that we may fear less.';

String kQueteAr='لا يوجد شيء في الحياة يجعلك تخاف، '
    'وفقط ليكون مفهوما. حان الوقت الآن لفهم المزيد,'
'حتى نخاف أقل.';
